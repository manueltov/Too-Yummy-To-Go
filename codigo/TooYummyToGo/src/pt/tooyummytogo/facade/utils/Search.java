...
public class Search {
	...
	public List<ComercianteInfo> searchIt(LocalDateTime horaInicio,LocalDateTime horaFim,Float raio,PosicaoCoordenadas coordinates) throws NoMerchantInAreaException {
