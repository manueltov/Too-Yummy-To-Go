...
public class SearchPorPeriodoStrategy implements SearchStrategy {

	public List<ComercianteInfo> redefinePeriodo(LocalDateTime horaInicio, LocalDateTime horaFim,
